...
class TeamInfoViewController: UIViewController {
    ...
    @objc func navigateToTeamIntro() {
        ...
        let detailLabel: UILabel = {
            let label = UILabel()
            label.translatesAutoresizingMaskIntoConstraints = false
            label.text = "핑거 스냅에서 살아남은 사람들로 구성된 팀 블립은 \n\n전직 최전방 군 간부로 수많은 작전을 성공적으로 수행한 프로젝트 지휘관. 게임과 헬스를 통해 신체와 정신의 한계를 돌파하며, 매 순간 최적의 판단을 내리는 팀플레이의 마에스트로 김석준 클라이밍에 모든 것을 바친 자연의 개척자. \n\n검은색의 세련됨을 즐기며, 소고기로 에너지를 충전해 고난도의 코스를 정복하는 차세대 클라이밍 브랜드 CEO가 될 양정무 \n\n커피 브루잉의 정교함을 즐기는 미식가이자, 강아지 봄이와의 일상을 차분히 책임지는 헌신적인 보호자. 일상 속 면과 고기, 그리고 올리브 그린으로 취향과 감각을 세련되게 표현하는 박진홍 \n\n위 세 명으로 이루어진 3조의 생존자들입니다."
            label.textColor = .white
